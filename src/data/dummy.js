...
const areaChartData = [
  [
    { x: new Date(2013, 0, 1), y: 3.4 },
    { x: new Date(2014, 0, 1), y: 2.8 },
    { x: new Date(2015, 0, 1), y: 1.6 },
    { x: new Date(2016, 0, 1), y: 2.3 },
    { x: new Date(2017, 0, 1), y: 2.5 },
    { x: new Date(2018, 0, 1), y: 2.9 },
    { x: new Date(2019, 0, 1), y: 3.8 },
    { x: new Date(2020, 0, 1), y: 1.4 },
    { x: new Date(2021, 0, 1), y: 3.1 },
    { x: new Date(2022, 0, 1), y: 3.1 },
  ],
  [
    { x: new Date(2013, 0, 1), y: 1.7 },
    { x: new Date(2014, 0, 1), y: 1.8 },
    { x: new Date(2015, 0, 1), y: 2.1 },
    { x: new Date(2016, 0, 1), y: 2.3 },
    { x: new Date(2017, 0, 1), y: 1.7 },
    { x: new Date(2018, 0, 1), y: 1.5 },
    { x: new Date(2019, 0, 1), y: 2.8 },
    { x: new Date(2020, 0, 1), y: 1.5 },
    { x: new Date(2021, 0, 1), y: 2.3 },
    { x: new Date(2022, 0, 1), y: 2.3 },
  ],
  [
    { x: new Date(2013, 0, 1), y: 1.3 },
    { x: new Date(2014, 0, 1), y: 1.1 },
    { x: new Date(2015, 0, 1), y: 1.6 },
    { x: new Date(2016, 0, 1), y: 2 },
    { x: new Date(2017, 0, 1), y: 1.7 },
    { x: new Date(2018, 0, 1), y: 2.3 },
    { x: new Date(2019, 0, 1), y: 2.7 },
    { x: new Date(2020, 0, 1), y: 1.1 },
    { x: new Date(2021, 0, 1), y: 2.3 },
    { x: new Date(2022, 0, 1), y: 2.3 },
  ],
];
...
export const customersData = [
  ...
  },
  {
    ...
    CustomerName: "Jumaboyev Jasurbek",
    CustomerEmail: "jumaboyevjasurbek2004gmail.com",
  ...
  },
  {
    ...
    CustomerName: "Jumaboyev Jasurbek",
    CustomerEmail: "jumaboyevjasurbek2004@gmail.com",
    ProjectName: "Web-Developer",
    Status: "Completed",
    CustomerImage: avatar,
    StatusBg: "#8BE78B",
